 ...
 * @author Frost
 */
public class PolynomialGUISecant extends javax.swing.JFrame {
...
public String getPolynomial() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Polynomial (Secant Method)");
...
try {
    ...
    if (coefficient.scale() > 0) {
        JOptionPane.showMessageDialog(PolynomialGUISecant.this, "Coefficient cannot have a decimal.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
} catch (NumberFormatException ex) {
    JOptionPane.showMessageDialog(PolynomialGUISecant.this, "Invalid coefficient input.", "Error", JOptionPane.ERROR_MESSAGE);
    return;
}
...
try {
    ...
    if (power < 0) {
        JOptionPane.showMessageDialog(PolynomialGUISecant.this, "Power cannot be negative.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
} catch (NumberFormatException ex) {
    JOptionPane.showMessageDialog(PolynomialGUISecant.this, "Invalid power input.", "Error", JOptionPane.ERROR_MESSAGE);
    return;
}
...
coeffField.requestFocus();
   ...
   if (upperFx.multiply(lowerFx).compareTo(new BigDecimal("0")) > 0) {
       JOptionPane.showMessageDialog(PolynomialGUISecant.this, "FUNCTION DOESNT HAVE A ROOT","Error",JOptionPane.ERROR_MESSAGE);
       return;
   }

   if (terms.isEmpty()) {
       JOptionPane.showMessageDialog(PolynomialGUISecant.this, "Polynomial must have at least one term.", "Error", JOptionPane.ERROR_MESSAGE);
       return;
   }
   ...
   setVisible(false);
   InitialBoundsSecant upLow1 = new InitialBoundsSecant(terms, coefficients, degree);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolynomialGUISecant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PolynomialGUISecant().setVisible(true);
            }
        });
    }
