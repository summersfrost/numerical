 ...
 * @author Frost
 */
public class PolynomialGUIBisection extends javax.swing.JFrame {
 ...
 public String getPolynomial() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Polynomial (BISECTION METHOD)");
    ...
    try {
        ...
        if (coefficient.scale() > 0) {
            JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "Coefficient cannot have a decimal.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    } catch (NumberFormatException ex) {
        JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "Invalid coefficient input.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    try {
        ...
        if (power < 0) {
            JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "Power cannot be negative.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    } catch (NumberFormatException ex) {
        JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "Invalid power input.", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
...
public  String createPolynomialString(BigDecimal[] coefficients, int[] degrees) {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
     ...
     if (upperFx.multiply(lowerFx).compareTo(new BigDecimal("0")) > 0) {
       JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "FUNCTION DOESNT HAVE A ROOT", "Error", JOptionPane.ERROR_MESSAGE);
       return;
     }

     if (terms.isEmpty()) {
       JOptionPane.showMessageDialog(PolynomialGUIBisection.this, "Polynomial must have at least one term.", "Error", JOptionPane.ERROR_MESSAGE);
       return;
     }
     ...
     setVisible(false);
     InitialBoundsBisection upLow1 = new InitialBoundsBisection(terms, coefficients, degree);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolynomialGUIBisection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PolynomialGUIBisection().setVisible(true);
            }
        });
    }
