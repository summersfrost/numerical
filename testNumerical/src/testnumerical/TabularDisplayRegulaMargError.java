 ...
 * @author Frost
 */
public class TabularDisplayRegulaMargError extends javax.swing.JFrame {
/**
 * Creates new form TabularDisplayRegulaMargError
 */
String terms;
BigDecimal error;
public TabularDisplayRegulaMargError(String terms, List < BigDecimal > lowerBound, List < BigDecimal > upperBound, List < BigDecimal > fxLowerBound, List < BigDecimal > fxUpperBound, List < BigDecimal > middleBound, List < BigDecimal > fxMiddleBound, List < Integer > TruthTable, BigDecimal error) {
        this.terms = terms;
        this.error = error;
    ...
    private void initComponents() {
        ...
        jLabel6.setText("FALSE POSITION");
