 ...
 * @author Frost
 */
public class tabularDisplayRegulaMaxIter extends javax.swing.JFrame {
/**
...
int middleSize;
public tabularDisplayRegulaMaxIter(String terms, List < BigDecimal > lowerBound, List < BigDecimal > upperBound, List < BigDecimal > fxLowerBound, List < BigDecimal > fxUpperBound, List < BigDecimal > middleBound, List < BigDecimal > fxMiddleBound) {
        this.terms = terms;
